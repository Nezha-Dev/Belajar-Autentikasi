...
<head>
    ...
    <!-- CSS Bootstrap -->
    <link rel="stylesheet" href="/assets/backend/css/vendors/bootstrap.min.css">
    <!-- CSS Utama -->
    <link rel="stylesheet" href="/assets/backend/css/style.css">
    <link id="color" rel="stylesheet" href="/assets/backend/css/color-1.css" media="screen">
    <!-- CSS Responsive -->
...
<body>
    ...
    <script src="/assets/backend/js/fontawesome.min.js"></script>
